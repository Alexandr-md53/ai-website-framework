...
def get_item_ui_schema():
    return {"id":{"widget":FieldWidgetType.HIDDEN},"title":{"widget":FieldWidgetType.TEXT,"required":True},"slug":{"widget":FieldWidgetType.TEXT,"required":True,"unique":True},"content":{"widget":FieldWidgetType.TEXTAREA,"required":True},"category_id":{"widget":FieldWidgetType.SELECT,"source":"Category","required":True},"status":{"widget":FieldWidgetType.SELECT,"options":[e.value for e in ItemStatus]},"tag_ids":{"widget":FieldWidgetType.MULTI_SELECT,"source":"Tag"},"media_ids":{"widget":FieldWidgetType.MULTI_SELECT,"source":"Media"},"seo_title":{"widget":FieldWidgetType.TEXT},"seo_description":{"widget":FieldWidgetType.TEXTAREA},"og_title":{"widget":FieldWidgetType.TEXT},"og_description":{"widget":FieldWidgetType.TEXTAREA}}
