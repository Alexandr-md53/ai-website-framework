...
from showcases.lawyer.application.submit_request_use_case import SubmitConsultationRequestUseCase
from showcases.lawyer.api.dto_factories import submit_request_dto_factory
...
def _make_use_case_map(service: LawyerService) -> Dict[Tuple[str, str], Tuple[Any, Callable[[Dict[str, Any]], Any]]]:
...
def build_lawyer_app(service_override: Optional[LawyerService] = None):
    ...
    info = ProductInfo(name="lawyer", path="showcases/lawyer", manifest={"name": "lawyer", "product": "crud", "version": "10.2.0-c1", "package": "showcases.lawyer"})
